...
final class Windows1256Codec extends dart_convert.Encoding {
  /// Creates a new []
  ///
...
final class Windows1256Decoder extends WindowsDecoder {
  /// Creates a new []
  ///
  /// Set [allowInvalid] to `true` for ignoring invalid data.
...
final class Windows1256Encoder extends WindowsEncoder {
  /// Creates a new []
  ///
  /// Set [allowInvalid] to `true` for ignoring invalid data.
